          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mb-8">
              <span className="text-base text-gray-600">
                الفئة: <span className="font-semibold text-primary">{productCategory}</span>
              </span>
            </div>
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {similarProducts.map((similarProduct) => {
                ...
                const similarUrl = `/ar/tarifs/${similarSlug}`;
                  ...
                  >
                    <div className="relative w-full h-56 bg-white">
                      <Image
                        ...
                        alt={similarProduct.nameProduct || "منتج"}
                        fill
                    ...
                    <div className="p-5">
                      ...
                      <p className="text-xl font-bold text-gray-900">
                        {similarProduct.prix ? `${similarProduct.prix} درهم` : "على التقدير"}
                      </p>
                    </div>
                  </div>
                );
