        ...
        <SectionMargin>
          <div className="max-w-7xl mx-auto">
            ...
            <div className="max-w-4xl mx-auto">
              {/* Introduction */}
              <div className="text-center mb-12">
                <h3 className="text-2xl md:text-3xl font-bold text-tertiary mb-4">
                ...
                <p className="text-base text-gray-600">
                  Remplissez simplement le formulaire ci-dessous et notre équipe vous contactera rapidement pour établir un devis adapté à vos besoins.
                </p>
              </div>

              {/* Contact Info */}
              <div className="bg-primary/5 rounded-xl p-6 mb-8 text-center">
                <div className="flex items-center justify-center gap-2">
                  <Phone className="w-5 h-5 text-primary flex-shrink-0" />
                  <p className="text-base font-semibold text-tertiary">
                    Notre service commercial est à votre écoute 7j/7 pour répondre à toutes vos demandes.
                  </p>
                </div>
              </div>
