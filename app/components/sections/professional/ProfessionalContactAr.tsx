            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-12 text-right">
                ...
                <p className="text-base text-gray-600">
                  يرجى تعبئة النموذج أدناه، وسيتواصل معك فريقنا قريبًا لتقديم عرض مناسب لاحتياجاتك.
                </p>
              </div>
              ...
              <div className="bg-primary/5 rounded-xl p-6 mb-8 text-center">
                <div className="flex items-center justify-center gap-2">
                  <p className="text-base font-semibold text-tertiary">
                    فريقنا التجاري متاح لخدمتك طوال الأسبوع لتلبية جميع احتياجاتك.
                  </p>
              ...
              <h3 className="text-2xl font-bold text-tertiary mb-6 text-right">
